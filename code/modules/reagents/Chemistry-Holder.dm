...
/datum/reagents/proc/process_reactions()
	...
	for(var/thing in reagent_volumes)
		...
		if(!R.bypass_cooling_products_for_root_type && LAZYLEN(R.chilling_products) && temperature <= R.chilling_point)
		...
		else if(!R.bypass_heating_products_for_root_type && LAZYLEN(R.heating_products) && temperature >= R.heating_point)
