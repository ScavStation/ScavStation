/obj/item/clothing/gloves
	sprite_sheets = list(SPECIES_YINGLET = 'code/content_packages/valsalia/icons/onmob_hands_yinglet.dmi')
...
/obj/item/clothing/under/tradeship_plain
	...
	icon = 'code/content_packages/valsalia/icons/under.dmi'
	icon_state = "plainclothes"
	species_restricted = list(SPECIES_HUMAN)
	item_icons = list(
		slot_w_uniform_str = 'code/content_packages/valsalia/icons/onmob_under.dmi'
	)
...
/obj/item/clothing/suit/storage/toggle/redcoat
	...
	icon = 'code/content_packages/valsalia/icons/suit.dmi'
	icon_state = "redcoat"
	item_icons = list(
		slot_wear_suit_str = 'code/content_packages/valsalia/icons/onmob_suit.dmi'
	)
