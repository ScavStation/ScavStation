/obj/item/clothing/suit/storage/toggle/redcoat/yinglet
	...
	icon = 'code/content_packages/valsalia/icons/suit_yinglet.dmi'
...
/obj/item/clothing/under/yinglet
	...
	species_restricted = list(SPECIES_YINGLET)
	icon = 'code/content_packages/valsalia/icons/under_yinglet.dmi'
	icon_state = "loincloth"
	sprite_sheets = list(SPECIES_YINGLET = 'code/content_packages/valsalia/icons/onmob_under_yinglet.dmi')
	color = COLOR_BEIGE
	var/detail_color
...
/obj/item/clothing/under/yinglet/get_mob_overlay(mob/user_mob, slot)
	...
	if(detail_color && slot == slot_w_uniform_str)
		var/image/I = image('code/content_packages/valsalia/icons/onmob_under_yinglet.dmi', "[icon_state]_detail")
...
/obj/item/clothing/head/yinglet
	...
	icon = 'code/content_packages/valsalia/icons/head_yinglet.dmi'
	icon_state = "ying_hood"
	flags_inv = BLOCKHAIR
	species_restricted = list(SPECIES_YINGLET)
	sprite_sheets = list(SPECIES_YINGLET = 'code/content_packages/valsalia/icons/onmob_head_yinglet.dmi')
	color = COLOR_BEIGE
	var/detail_color
...
/obj/item/clothing/head/yinglet/get_mob_overlay(mob/user_mob, slot)
	...
	if(detail_color && slot == slot_head_str)
		var/image/I = image('code/content_packages/valsalia/icons/onmob_head_yinglet.dmi', "[icon_state]_detail")
		I.color = detail_color
		I.appearance_flags |= RESET_COLOR
		ret.overlays += I
	. = ret
...
/obj/item/clothing/suit/yinglet
	...
	sprite_sheets = list(SPECIES_YINGLET = 'code/content_packages/valsalia/icons/onmob_suit_yinglet.dmi')
...
/obj/item/clothing/shoes/sandal/yinglet
	...
	species_restricted = list(SPECIES_YINGLET)
	item_icons = list(
		slot_shoes_str = 'code/content_packages/valsalia/icons/onmob_shoes_yinglet.dmi'
	)
