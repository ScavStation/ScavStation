...
then
  ...
  curl "http://www.byond.com/download/build/${BYOND_MAJOR}/${BYOND_MAJOR}.${BYOND_MINOR}_byond_linux.zip" -H "User-Agent: Scavstation/1.0 Continuous Integration" -o byond.zip
  unzip -o byond.zip
  cd byond
  make here
fi
