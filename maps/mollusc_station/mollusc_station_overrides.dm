/datum/computer_file/program/merchant/mollusc_station
	read_access = list()

/obj/machinery/computer/modular/preset/merchant/mollusc_station
...
// This has to be here rather than mollusc_station_define.dm because it's from a modpack.
/datum/map/mollusc_station
	default_law_type = /datum/ai_laws/nanotrasen

/datum/map/mollusc_station/New()
