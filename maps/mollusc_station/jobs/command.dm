/datum/job/mollusc_station/captain
	title = "Captain"
	alt_titles = list("El Capit�n de Decisiones Extremadamente Apresuradas y Grandiosas", "Interim Captain", "Supreme Patriarch", "Supreme Matriarch")
	supervisors = "your profit margin, your conscience, and the watchful eye of the Tradehouse Rep"
	outfit_type = /decl/outfit/job/mollusc_station/captain
	min_skill = list(
...
/datum/job/mollusc_station/captain/equip_job(var/mob/living/human/H, var/alt_title, var/datum/mil_branch/branch, var/datum/mil_rank/grade)
	. = ..()
	if(H)
		H.verbs |= /mob/proc/freetradeunion_rename_company

/datum/job/mollusc_station/captain/get_access()
...
/datum/job/mollusc_station/hop
	...
	outfit_type = /decl/outfit/job/mollusc_station/hop
	head_position = 1
