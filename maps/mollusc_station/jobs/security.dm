/datum/job/mollusc_station/security
	...
	spawn_positions = 3
	total_positions = 3
	outfit_type = /decl/outfit/job/mollusc_station/security
...
/datum/job/mollusc_station/detective
	...
	spawn_positions = 1
	total_positions = 1
	outfit_type = /decl/outfit/job/mollusc_station/detective
	department_types = list(/decl/department/security)
...
/datum/job/mollusc_station/security/head
	...
	outfit_type = /decl/outfit/job/mollusc_station/security/head
	head_position = 1
