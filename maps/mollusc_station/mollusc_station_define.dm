/datum/map/mollusc_station
	name = "Mollusc Station"
	full_name = "Tradepost Mollusc"
	path = "mollusc_station"
	ground_noun = "floor"
	...
	lobby_screens = list('maps/mollusc_station/lobbyscreen/mollusc_station_lobby.png', 'maps/mollusc_station/lobbyscreen/mollusc_station_lobby2.png', 'maps/mollusc_station/lobbyscreen/mollusc_station_lobby3.png', 'maps/mollusc_station/lobbyscreen/mollusc_station_lobby4.png', 'maps/mollusc_station/lobbyscreen/mollusc_station_lobby5.png')
...
/datum/map/mollusc_station/get_map_info()
