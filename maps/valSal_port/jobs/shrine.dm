/decl/department/valSal_port/shrine
	name          = "Shrine Attendants"
	colour        = "#404e68"
	display_color = "#8c96c4"

/datum/job/valSal_port/shrine
	abstract_type    = /datum/job/valSal_port/shrine
	department_types = list(/decl/department/valSal_port/shrine)
	skill_points     = 20
	lock_keys     = list(
...
/datum/job/valSal_port/shrine/keeper
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/valSal_port/shrine/keeper
	min_skill               = list(
...
/obj/abstract/landmark/start/valSal_port/shrine_keeper
	name                    = "Shrine Keeper"
...
/datum/job/valSal_port/shrine/attendant
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/valSal_port/shrine
	min_skill               = list(
		SKILL_STONEMASONRY  = SKILL_BASIC,
		SKILL_CARPENTRY     = SKILL_BASIC,
		SKILL_TEXTILES      = SKILL_BASIC,
...
/obj/abstract/landmark/start/valSal_port/shrine_attendant
