/*
/decl/department/valSal_port/inn
	name                    = "Inn Workers"
	colour                  = "#404e68"
	display_color           = "#8c96c4"

/datum/job/valSal_port/inn
	abstract_type           = /datum/job/valSal_port/inn
	department_types        = list(/decl/department/valSal_port/inn)
...
/datum/job/valSal_port/inn/innkeeper
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/valSal_port/innkeeper
	head_position           = TRUE
...
/obj/abstract/landmark/start/valSal_port/innkeeper
	name                    = "Innkeeper"
...
/datum/job/valSal_port/inn/inn_worker
	...
	spawn_positions         = 3
	total_positions         = 3
	outfit_type             = /decl/outfit/job/valSal_port/inn_worker
	min_skill               = list(
...
/obj/abstract/landmark/start/valSal_port/inn_worker
	name                    = "Inn Worker"
...
/datum/job/valSal_port/inn/bartender
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/valSal_port/bartender
	min_skill               = list(
...
/obj/abstract/landmark/start/valSal_port/bartender
	name                    = "Bartender"
...
/datum/job/valSal_port/inn/farmer
	...
	spawn_positions         = 3
	total_positions         = 3
	outfit_type             = /decl/outfit/job/valSal_port/farmer
	min_skill               = list(
...
/obj/abstract/landmark/start/valSal_port/farmer
	name                    = "Farmer"
...
/datum/job/valSal_port/inn/storekeeper
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/valSal_port/storekeeper
	min_skill               = list(
...
/obj/abstract/landmark/start/valSal_port/storekeeper
	name                    = "Storekeeper"
*/