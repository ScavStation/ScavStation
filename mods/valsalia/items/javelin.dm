/obj/item/twohanded/spear/attackby(obj/item/W, mob/user) // make a javelin from a spear
	. = ..()
	if(istype(W, /obj/item/wirecutters))
		...
		user.put_in_hands(new /obj/item/twohanded/spear/javelin(get_turf(user), material.type))
		qdel(src)
...
/obj/item/twohanded/spear/javelin/update_twohanding() //overrides to allow two hands
...
/datum/codex_entry/spear
	associated_paths = list(/obj/item/twohanded/spear, /obj/item/twohanded/spear/javelin)
