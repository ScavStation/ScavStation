...
/decl/modpack/valsalia
	...
	credits_other = list(
		...
		"THE GREAT PRAIRE SCAVS",
		"DEATH IN THE ENCLAVE",
		"THE OMEGAS WERE INVOLVED IN THIS ONE",
		"SCAVCRAFT GOES WRONG",
		"DR. SCAVLOVE, OR HOW I LEARNED TO STOP WORRYING AND LOVE ZHE STONE"
	)
